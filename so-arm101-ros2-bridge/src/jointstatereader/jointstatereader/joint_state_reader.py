...
class JointStateReader(Node):
    def __init__(self):
        ...
        # Calibration: load offsets and signs to match irl_robotics backend (same formula as _units_vec_to_radians)
    ...
    def ticks_to_radians(self, ticks, joint_idx):
        """Convert servo ticks (0-4095) to radians using calibration (same formula as irl_robotics backend)."""
        if ticks is None:
