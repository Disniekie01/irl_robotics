...
from irl_robotics.models.robot import BaseRobot
...
class BaseEpisode(BaseModel, ABC):
    ...
    def load(
        ...
        """
        from irl_robotics.models.lerobot_dataset import LeRobotEpisode
...
class JsonEpisode(BaseEpisode):
    ...
    async def start_new(  # type: ignore[override]
        cls,
        base_recording_folder: str,  # e.g., ".../irl_robotics/recordings"
        dataset_name: str,
        robots: List[BaseRobot],
...
**This dataset was generated using [irl_robotics](https://docs.irlrobotics.ai).**
...
To get started in robotics, [get your own irl_robotics starter pack.](https://robots.irlrobotics.ai).
"""
