...
async def get_model_configuration(
    ...
    from irl_robotics.am import ACT, Gr00tN1, SmolVLA
...
async def get_training_info(
    ...
    try:
        ...
        if private_mode:
            ...
            # Use irl-robotics namespace for public training
            model_name = f"irl-robotics/{username_or_orgid}-{request.model_type}-{request.model_id.split('/')[1]}-{random_suffix}"
