...
from irl_robotics.am.base import TrainingParamsGr00T, TrainingRequest
...
from irl_robotics.utils import get_hf_token, get_home_app_path, get_tokens
...
async def start_training(
    ...
    if request.private_mode:
        from irl_robotics.endpoints.auth import check_pro_user
