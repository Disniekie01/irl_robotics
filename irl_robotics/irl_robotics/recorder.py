...
from irl_robotics.camera import AllCameras, BaseCamera, get_all_cameras
from irl_robotics.configs import config
from irl_robotics.hardware import BaseRobot
...
from irl_robotics.rerun_visualizer import RerunVisualizer
...
class Recorder:
    ...
    def episode_recording_folder(
        self,
    ) -> str:  # Base folder for all recordings (".../irl_robotics/recordings")
