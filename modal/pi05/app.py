...
from irl_robotics.am.pi05 import Pi05SpawnConfig
from irl_robotics.am.base import TrainingParamsPi05, generate_readme
...
pi0_image = (
    ...
    .run_commands(  # clone openpi source code from last commit, we do this to be able to refresh the build when changing the repo
        "git clone https://github.com/irl-robotics/openpi.git /openpi-source && cd /openpi-source && git checkout 2c7f6eef0cf2bd2d547ccdffe8e115b846fcec42"
    )
    .run_commands(
