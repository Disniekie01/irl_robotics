...
async def convert_dataset_to_v3(
    ...
    If not, we reupload a version of the dataset on the irl_robotics cloud.
    """
    import os
    ...
    try:
        ...
        if huggingface_token is not None:
            ...
            if dataset_name.startswith("irl-robotics/"):
            ...
            new_repo = "irl-robotics/" + dataset_name.split("/")[-1]
            create_repo(
                repo_id=new_repo,
                repo_type="dataset",
                exist_ok=True,
