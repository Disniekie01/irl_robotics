...
from irl_robotics.am.smolvla import SmolVLASpawnConfig
...
irl_robotics_dir = (
    Path(__file__).parent.parent.parent.parent / "irl_robotics" / "irl_robotics"
)
...
def create_training_command(
    ...
    cmd = [
        ...
        f"--wandb.project=irl_robotics-{model_type.upper()}",
