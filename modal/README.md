...
We use modal as a GPU provider, irl_robotics can train and run inference on several robotics models by running the scripts in this folder through modal.
...
- `admin`: FastAPI server used by `irl_robotics` to spin up gpus and models
