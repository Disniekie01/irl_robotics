...
export default function ComparisonTable() {
  const features = [
      ...
      name: (
        <>
          ...
          <div className="text-xs text-medium-gray">
            Access the{" "}
            <a
              href="https://www.meta.com/en-gb/experiences/IRL Robotics-teleoperation/8873978782723478/?srsltid=AfmBOorMv4FFiW1uSPvz9cEgsrwhRa5r0-eQ7P-9RRSLcchwzJkBTzoB"
              target="_blank"
              rel="noopener noreferrer"
              className="text-IRL Robotics-green hover:text-IRL Robotics-green-dark underline transition-colors"
            >
              IRL Robotics teleoperation app
            </a>{" "}
    ...
    { name: "IRL Robotics Pro Discord badge", free: false, pro: true },
  ];
