...
```bash
git clone git@github.com:irl-robotics/irl_robotics.git
```
...
You can also use `irl_robotics info` to do that.
...
4. After programming your servo and replacing it, you then need to **recalibrate** your robot arm. ([Example with SO-100 and irl_robotics](https://www.youtube.com/watch?v=65DW8yLcRmM))
