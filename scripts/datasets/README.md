...
For example: uv run remove_duplicate_arms.py --dataset-path ~/irl_robotics/recordings/lerobot_v2/example_dataset
...
For example: uv run repair_dataset.py --dataset-path ~/irl_robotics/recordings/lerobot_v2/example_dataset --indexes-to-delete 5,8
...
For example: uv run repair_dataset.py --dataset-path ~/irl_robotics/recordings/lerobot_v2/example_dataset
...
For example: uv run push_dataset_to_hf.py ~/irl_robotics/recordings/lerobot_v2/example_dataset example_name
