...
COLOR_TO_EPISODE = {
    "green": {
        "episode_id": 7,
        "episode_path": "/Users/pierre-alexandreboulay/irl_robotics/recordings/lerobot_v2/AI-voice-control-demo/data/chunk-000/episode_000007.parquet"
    },
    "blue": {
        "episode_id": 5,
        "episode_path": "/Users/pierre-alexandreboulay/irl_robotics/recordings/lerobot_v2/AI-voice-control-demo/data/chunk-000/episode_000005.parquet"
    },
    "red": {
        "episode_id": 6,
        "episode_path": "/Users/pierre-alexandreboulay/irl_robotics/recordings/lerobot_v2/AI-voice-control-demo/data/chunk-000/episode_000006.parquet"
    }
}

IRL_ROBOTICS_API_URL = "http://0.0.0.0:80/recording/play"
    ...
    if action == "pick_and_place":
        for color, episode_info in COLOR_TO_EPISODE.items():
            if color in obj:
                ...
                print(f"🚀 Sending replay command for {color} brick to IRL Robotics API...")
                response = requests.post(IRL_ROBOTICS_API_URL, json=payload)
