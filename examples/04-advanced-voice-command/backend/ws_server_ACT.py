...
from irl_robotics.api.client import IRLRoboticsApi
...
client = IRLRoboticsApi(base_url="http://localhost:80")

MODEL_ID = "irl-robotics/PAphospho-AI-voice-lego-red-2-6lp91kv18x"
...
if __name__ == "__main__":
    ...
    act_server_process = subprocess.Popen(
        [
            "uv",
            "run",
            "../../irl_robotics/inference/ACT/server.py",
            "--model_id",
            MODEL_ID,
        ],
