  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 text-white flex flex-col items-center justify-center relative px-4">
      ...
      <div className="absolute top-6 left-6">
        <Image src="/phospho-logo.png" alt="IRL Robotics Logo" width={120} height={40} />
      </div>
      ...
      {/* Title */}
      <h1 className="text-3xl md:text-4xl font-bold mb-2 text-center">Talk to irl_robotics</h1>
