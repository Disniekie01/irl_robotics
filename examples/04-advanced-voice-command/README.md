# IRL Robotics AI Voice Demo

This demo showcases the voice-enabled AI assistant capabilities of IRL Robotics, allowing users to interact with an AI through voice commands and receive spoken responses. It can also control a robot arm when connected to the IRL Robotics hardware.
...
- For robot arm control: IRL Robotics hardware setup
...
1. Ensure the IRL Robotics hardware is correctly set up and connected
2. The IRL Robotics API server should be running on the default port (http://localhost:80)
...
This project is part of IRL Robotics.
...
- For robot control issues, verify the IRL Robotics API server is running and accessible
