...
Welcome! This folder hosts small, runnable demos that show how to use **IRL Robotics** in isolation.  
Pick the one closest to your use-case.

## Prerequisites

- Python 3.6+
- A computer running the IRL Robotics server (see [installation instructions](https://docs.phospho.ai/installation))
