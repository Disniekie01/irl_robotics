...
class SO100IntegratedControl:
    ...
    def setup_configuration(self):
        ...
        self.irl_robotics_ip = "192.168.178.190"
        self.irl_robotics_port = 80
        ...
        if endpoint_input:
            ...
            if ":" in endpoint_input:
                self.irl_robotics_ip = endpoint_input.split(":")[0]
                self.irl_robotics_port = int(endpoint_input.split(":")[1])
            else:
                self.irl_robotics_ip = endpoint_input
                self.irl_robotics_port = 80
        
        self.joints_read_url = f"http://{self.irl_robotics_ip}:{self.irl_robotics_port}/joints/read"
