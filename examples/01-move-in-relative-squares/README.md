# IRL Robotics: Move in Relative Squares Example

This example demonstrates how to use the IRL Robotics API to move a robot in square patterns using relative positioning.

## Prerequisites

- Python 3.6+
- A robot running the IRL Robotics server
...
1. Make sure your robot is powered on and the IRL Robotics server is running
