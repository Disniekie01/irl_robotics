...
interface GlobalStore {
  ...
  selectedModelType: "pi0.5" | "ACT" | "ACT_BBOX" | "gr00t" | "smolvla" | "smolvla_local" | "gr00t_local" | "custom";
  setSelectedModelType: (
    modelType: "pi0.5" | "ACT" | "ACT_BBOX" | "gr00t" | "smolvla" | "smolvla_local" | "gr00t_local" | "custom",
  ) => void;
...
const useGlobalStore = create(
  persist<GlobalStore>(
    ...
    {
      name: "irl_robotics-global-store",
