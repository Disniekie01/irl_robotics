...
export function Footer() {
  ...
  return (
    <footer className="mt-8 py-3 border-t border-border flex items-center">
      <div className="flex items-center gap-2 text-xs text-muted-foreground w-full">
        ...
        <button
          onClick={() => window.open("https://github.com/Disniekie01/irl_robotics", "_blank")}
          className="hover:text-foreground transition-colors p-0.5"
        >
        ...
        <span className="font-mono text-[11px]">
          v{serverStatus?.version_id}
          {!isLatest && (
            <span className="text-primary ml-1">update available</span>
          )}
        </span>
        ...
        {!isLatest && (operatingSystem == "macos" || operatingSystem == "windows") && (
          <Popover>
            ...
            <PopoverContent className="w-96 p-4 flex flex-col gap-2 text-muted-foreground text-sm" side="top">
              {operatingSystem === "macos" ? (
                ...
                <>
                  <CodeSnippet
                    title="Update"
                    code={`powershell -ExecutionPolicy ByPass -Command "irm https://raw.githubusercontent.com/Disniekie01/irl_robotics/main/install.ps1 | iex"`}
                    language="powershell"
                    showLineNumbers={false}
                  />
                  <button
                    onClick={() => window.open("https://github.com/Disniekie01/irl_robotics/releases/latest", "_blank")}
