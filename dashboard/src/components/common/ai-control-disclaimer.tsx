  ...
  return (
    <div className="space-y-4">
      <div className="flex items-start gap-3 p-3 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-md">
        <Shield className="size-5 text-indigo-400 mt-0.5 flex-shrink-0" />
        <div>
          <h4 className="font-semibold text-indigo-400-800 dark:text-indigo-400-300">
            Safety Precautions Required:
          </h4>
          <ul className="text-sm text-indigo-400-700 dark:text-indigo-300 mt-1 list-disc pl-5 space-y-1">
