...
import { MacrosControl } from "./MacrosPage";
...
export function ControlPage() {
  ...
  const controlOptions = [
    ...
    { value: "phone", icon: Smartphone, label: "Phone", tooltip: "Phone / touch control" },
    { value: "macros", icon: Clapperboard, label: "Macros", tooltip: "Record & replay sequences" },
  ];
